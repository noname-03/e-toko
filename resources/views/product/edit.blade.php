                        ...
                        <div class="sbp-preview-content">
                            <form action="{{ route('product.update', ['product'=>$product->id]) }}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="mb-3">
                                        <input type="text"  value="{{$product->name}}" name="name" id="first-name" required="required" class="form-control ">
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="mb-3">
                                        <input type="number"  value="{{$product->price}}" name="price" id="first-name" required="required" class="form-control ">
                                    </div>
                                </div>
                                <div class="item form-group">
